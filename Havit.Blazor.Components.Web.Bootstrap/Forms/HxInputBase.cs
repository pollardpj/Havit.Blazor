...
public abstract class HxInputBase<TValue> : InputBase<TValue>, ICascadeEnabledComponent, IFormValueComponent
{
	...
	/// <summary>
	/// When there is no EditContext cascading parameter, lets create a new one and passing it to CascadedEditContext private property in a base InputBase class.
	/// </summary>
	/// <remarks>
