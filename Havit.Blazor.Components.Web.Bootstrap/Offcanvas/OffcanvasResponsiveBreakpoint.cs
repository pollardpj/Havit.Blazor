...
public enum OffcanvasResponsiveBreakpoint
{
	...
	/// <summary>
	/// Render contents outside the viewport in an offcanvas when below "extra-large" breakpoint (<c>1200px</c>, exclusive).
	/// </summary>
	ExtraLarge = 5,

	/// <summary>
	/// Render contents outside the viewport in an offcanvas when below "XXL" breakpoint (<c>1400px</c>, exclusive).
	/// </summary>
	Xxl = 6,
}
